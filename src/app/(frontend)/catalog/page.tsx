...
export const metadata = {
  title: 'Katalog Seragam Hotel, Restaurant & Spa Bali | Candra Collection',
  description: 'Katalog custom uniform Candra Collection — seragam hotel, restaurant, spa, front office, housekeeping, corporate, polo, dan batik. Made to order di Bali, kirim ke seluruh Indonesia.',
